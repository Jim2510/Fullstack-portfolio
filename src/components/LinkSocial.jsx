        ...
        <motion.div
          ...
          <a href="https://www.reddit.com/user/LazyBoysenberry7816/">
            <svg
                ...
                className="bi bi-reddit fill-white transition duration-150 ease-out hover:fill-main-red"
                viewBox="0 0 16 16"
            >
              <path
          ...
          <a href="https://github.com/Jim2510">
            <svg
                ...
                height="20"
                fillRule="currentColor"
                className="w-[15px] h-[15px] sm:w-[20px] sm:h-[20px] bi bi-github  fill-white transition duration-150 ease-out hover:fill-main-red"
                viewBox="0 0 16 16"
            >
              <path
          ...
          <a href="https://www.threads.net/@not_so_gim?hl=it">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
                fillRule="currentColor"
                className="w-[15px] h-[15px] sm:w-[20px] sm:h-[20px] bi bi-thread s fill-white transition duration-150 ease-out hover:fill-main-red"
                viewBox="0 0 16 16"
            >
              <path
          ...
          <a href="https://www.instagram.com/not_so_gim/">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
                fillRule="currentColor"
                className="w-[15px] h-[15px] sm:w-[20px] sm:h-[20px] bi bi-instag ram fill-white transition duration-150 ease-out hover:fill-main-red"
                viewBox="0 0 16 16"
            >
              <path
          ...
          >
            <svg
                ...
                height="18"
                fillRule="currentColor"
                className="bi bi-linkedin fill-white transition duration-150 ease-out hover:fill-main-red"
                viewBox="0 0 16 16"
            >
              <path

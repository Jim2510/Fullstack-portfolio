...
export function ExpText({ title, clrTitle, date, sec1, sec2, sec3, sec4 }) {
  return (
    <>
      <div className="w-full flex flex-col justify-start items-start pl-0 sm:pl-4 pb-10 gap-4 transition-all ease-in-out">
        ...
        <div className="w-full flex justify-start items-center gap-5 min-h-[50px]">
          <div className="w-[20px] sm:flex hidden">
            <svg

                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <input
                          className="px-1 font-bold w-full sm:w-[350px] rounded-md h-[40px] text-md bg-black/50 backdrop-blur-2xl text-white"
                          type="text"
                          name="user_name"
                      />
                      ...
                      <textarea
                          className="pt-1 rounded-md px-2 font-bold w-full sm:w-[500px] h-[100px] bg-black/50 backdrop-blur-2xl text-white"
                          name="message"
                          id=""
                      ></textarea>
                      <input

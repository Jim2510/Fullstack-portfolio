...
export function Contact() {
  ...
  return (
    <>
      {showAlert && (
        <div
          className={`fixed top-0 left-0 w-full p-4 text-center z-50 transition-opacity duration-500 ${
      ...
      <div
        ...
        id="contact"
      >
        <div className="w-[40%] text-white flex justify-center items-center flex-col py-32 gap-8">
          <div className="flex justify-center items-center w-full flex-wrap mb-10 flex-col gap-4">
            <h3 className="w-fit mr-2 text-xl font-bold">
        ...
        <div
          className={`fixed top-0 left-0 w-full h-full backdrop-blur-xl flex z-50 justify-center items-center ${
            isOpen
              ? "animate__animated animate__fadeIn"
              : "animate__animated animate__fadeOut"
          } ${isOpen ? "flex" : "hidden"}`}
        >
          <div className="relative w-[50%] h-[55%] bg-custom-green/70">
            <div
            ...
            >
              <svg
                ...
                className="bi bi-x fill-slate-300"
                viewBox="0 0 16 16"
              >
            ...
            >
              ...
              <input
                className="px-1 font-bold w-[350px] rounded-md h-[40px] text-md"
                type="text"
                name="user_name"
              />
              ...
              <textarea
                className="pt-1 rounded-md px-2 font-bold w-[500px] h-[100px]"
                name="message"
                id=""
              ></textarea>
              <input
